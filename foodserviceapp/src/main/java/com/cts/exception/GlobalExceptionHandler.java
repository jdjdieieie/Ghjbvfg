...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OrderCannotBeMarkException.class)
    public ResponseEntity<ErrorResponse> handleOrderCannotBeMarkException(OrderCannotBeMarkException ex) {
        ErrorResponse error = new ErrorResponse(ex.getMessage(), HttpStatus.BAD_REQUEST);
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(PartnerIdNotFoundException.class)
    public ResponseEntity<ErrorResponse> handlePartnerIdNotFoundException(PartnerIdNotFoundException ex) {
        ErrorResponse error = new ErrorResponse(ex.getMessage(), HttpStatus.NOT_FOUND);
        return new ResponseEntity<>(error, HttpStatus.NOT_FOUND);
    }
    ...
    @ExceptionHandler(NoPartnerAvaliableException.class)
    public ResponseEntity<ErrorResponse> handleNoPartnerAvaliableException(NoPartnerAvaliableException ex) {
        ErrorResponse error = new ErrorResponse(ex.getMessage(), HttpStatus.NOT_FOUND);
        return new ResponseEntity<>(error, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(FoodNotInStockException.class)
    public ResponseEntity<ErrorResponse> handleFoodNotInStockException(FoodNotInStockException ex) {
        ErrorResponse error = new ErrorResponse(ex.getMessage(), HttpStatus.CONFLICT);
        return new ResponseEntity<>(error, HttpStatus.CONFLICT);
    }

    @ExceptionHandler(UserRoleIsNotValidException.class)
    public ResponseEntity<ErrorResponse> handleUserRoleIsNotValidException(UserRoleIsNotValidException ex) {
        ErrorResponse error = new ErrorResponse(ex.getMessage(), HttpStatus.BAD_REQUEST);
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }
