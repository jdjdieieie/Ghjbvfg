    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        http
            ...
            .authorizeExchange(auth -> auth
                ...
                .pathMatchers(HttpMethod.PUT, "/app1/api/v1/users/customer/update").hasAnyRole("ADMIN", "CUSTOMER")
                .pathMatchers(HttpMethod.PUT, "/app1/api/v1/users/customer/**").hasAnyRole("ADMIN", "CUSTOMER")
                .pathMatchers(HttpMethod.PUT, "/app1/api/v1/users/deliverypartner/update").hasRole("DELIVERY_PARTNER")
                ...
                .pathMatchers(HttpMethod.GET, "/app2/api/v1/orders/Deliverypartner/**").hasRole("DELIVERY_PARTNER")
                .pathMatchers(HttpMethod.PATCH, "/app2/api/v1/orders/Deliverypartner/**").hasRole("DELIVERY_PARTNER")
                .pathMatchers(HttpMethod.PUT, "/app2/api/v1/orders/Deliverypartner/**").hasRole("DELIVERY_PARTNER")
