...
public class FeedbackController {
    ...
    public ResponseEntity<?> submitFeedback(@Valid @RequestBody FoodFeedbackRequestDTO foodFeedbackRequestDTO, @PathVariable int foodId) {
  ...
  public ResponseEntity<List<FoodFeedbackResponseDTO>> getFeedbackByFood(@PathVariable Integer foodId) {
   ...
   public ResponseEntity<RatingResponseDTO> isFoodRatingGiven(@RequestParam int foodId, @RequestParam int orderId, @RequestParam Long customerId) {
